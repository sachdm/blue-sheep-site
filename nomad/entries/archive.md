# NOMAD — REVISION ARCHIVE

**superseded drafts and the logs that produced them · index only**
...
|---|---|---|
| v3.3 | last locked draft before the producer's margins | v3.4 |
| v3.4 | 32 pages of margin notes applied; golf-night filming, cubicle line, all-hands, folder thread, likeness release | v3.5 |
...
- **Log 04** — margin notes, ten programmers + producer lens
- **Logs 05–08** — v3.3 iteration passes
- **Log 09** — The Producer's Margins (v3.3 → v3.4)
...
- Perfect Days texture in the good-days stretch
